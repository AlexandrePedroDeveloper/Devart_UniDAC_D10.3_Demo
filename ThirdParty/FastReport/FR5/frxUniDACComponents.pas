...
type
  ...
  TfrxUniDACComponentsClass = class of TfrxUniDACComponents;
...
{$ENDIF}
  ...
  procedure RegisterDacComponents(Components: TfrxUniDACComponentsClass);
...
begin
  Result := TUniConnection(FDatabase).SpecificOptions as TStrings;
end;

procedure TfrxUniDACDatabase.SetSpecificOptions(Value: TStrings);
begin
  TUniConnection(FDatabase).SpecificOptions := Value as TSpecificOptionsList;
end;
...
begin
  Result := FTable.SpecificOptions as TStrings;
end;

procedure TfrxUniDACTable.SetSpecificOptions(Value: TStrings);
begin
  FTable.SpecificOptions := Value as TSpecificOptionsList;
end;
...
begin
  Result := (FQuery as TCustomUniDataSet).SpecificOptions as TStrings;
end;

procedure TfrxUniDACQuery.SetSpecificOptions(Value: TStrings);
begin
  (FQuery as TCustomUniDataSet).SpecificOptions := Value as TSpecificOptionsList;
end;
