...
SET DCCPATH=C:\Program Files\Embarcadero\RAD Studio\20.0\bin\

rem Path to project Dir
SET PROJECTPATH=C:\Program Files\Devart\UniDAC for RAD Studio 10.3\Demos\ThirdParty\FastReport\FR4\Delphi26\

rem FastReport 4 LibD26 Path
SET FRLIBDLLPATH=C:\Program Files\FastReports\FastReport 4\LibD26
